...
const Follows = () => {
  return (
    <div className="my-5 w-full shadow-sm bg-white text-gray-700 flex flex-row ">
      <div className="basis-1/2 px-8 border-r-[1px] border-gray-400">
        <header className="flex justify-start items-center gap-3 py-3 border-b-[1px] border-gray-100    ">
          <div className="bg-yellow-600 rounded-full p-[6px]"></div>
          <h1 className="font-semibold text-">Follow-up</h1>
          <Ri24HoursFill className="text-yellow-600 text-xl" />
        </header>
        <div className="flex gap-5 ">
          <h3 className="text-sm font-sans font-bold text-green-600 border-b-2 border-green-600 py-3 cursor-pointer ">
            ONBOARDING (15)
          </h3>
          <h3 className="text-sm font-sans font-bold py-3 cursor-pointer ">
            OFFBOARDING (5)
          </h3>
        </div>
        <div className="mt-3 flex gap-3 flex-col ">
          {data.slice(0, 2).map((item) => (
            <div
              ...
              key={item.id}
            >
              <h1 className="font-semibold text-sm font-sans flex items-center text-center gap-1 text-gray-500">
                <img
              ...
              <AiOutlineInfoCircle />
              <h1 className="font-semibold text-sm font-sans flex items-center justify-center gap-1 text-gray-400">
                3/6 completed
                <CircularProgressbar
                  strokeWidth={13}
          ...
          <h2 className="text-green-600 font-sans font-bold text-sm py-4 cursor-pointer ">
            View all
          </h2>
        </div>
      </div>
      <div className="basis-1/2 px-8">Right</div>
    </div>
  );
};

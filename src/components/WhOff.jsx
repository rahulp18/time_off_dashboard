    ...
    <div className="my-6 shadow-sm bg-white text-gray-700 px-8 pb-5">
      <header className="flex justify-between items-center gap-3 py-3  border-b-[1px] border-gray-300 ">
        <div className="flex justify-center items-center gap-2">
          ...
          <h1 className="font-bold font-sans text-md">Who's Off</h1>
          <GrCircleInformation className=" text-gray-700" />
        </div>
      </header>
      <div className="flex flex-col py-2">
        {data.map((item) => (
          <div key={item.id} className="flex items-center my-2 gap-2">
            <img
              src={item.img}
              alt="person"
            ...
            />
            <div className="">
              <h1 className="font-bold font-sans text-md">{item.name}</h1>
              <h3 className="text-sm font-medium">2 May</h3>
            </div>
          </div>
        ))}
      </div>
